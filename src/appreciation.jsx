export const Thanks = ()=>{
    return (
        ...
        <p className="additionalText">Thanks for confirming your subscription! We hope you have fun using our platform. If you ever need support, feel free to email us at support@loremgaming.com.</p>
        </div>
        </>
    )
}